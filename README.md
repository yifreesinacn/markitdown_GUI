...
- OCVSAL: Open Core Ventures Source Available License（开放核心风险投资源码可用许可证),一个“源码可用（Source-Available）”的许可证。
非商业/非生产用途免费：你可以在非生产环境中自由查看、修改、测试代码，甚至分享你的修改。
商业/生产用途需付费：只要将软件用于“生产环境”，就必须与版权持有者签订商业协议（如订阅或合同）并支付费用。
免责声明：软件按“原样”提供，不提供任何担保。特别的是，如果你的所在地法律不允许这种免责声明，那么你将自动失去使用该软件的任何许可。
