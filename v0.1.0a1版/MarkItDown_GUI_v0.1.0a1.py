...
class MarkItDownApp:
    def __init__(self, root):
        self.root = root
        self.root.title('MarkItDown 文档转换工具 v0.1.0a1版 【飞歌制作 2025年3月11日】')
    ...
    def create_header(self):
        ...
        # 标题
        title_label = ttk.Label(header_frame, text='MarkItDown 文档转换工具 v0.1.0a1', style='Header.TLabel')
    ...
    def create_statusbar(self):
        ...
        version_label = ttk.Label(self.statusbar, text='v0.1.0a1')
